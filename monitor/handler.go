...
func (h *Handler) HandleCreate(w http.ResponseWriter, r *http.Request) {
	...
	m, err := h.service.Create(r.Context(), req.URL, req.ExpectedStatus, req.BodyContains, req.IntervalSeconds, req.UserAgent)
	if err != nil {
...
func (h *Handler) HandleUpdate(w http.ResponseWriter, r *http.Request) {
	...
	m, err := h.service.Update(r.Context(), id, req.URL, req.ExpectedStatus, req.BodyContains, req.IntervalSeconds, req.UserAgent)
	if err != nil {
		if errors.Is(err, domain.ErrMonitorNotFound) {
			response.WriteError(w, http.StatusNotFound, err.Error())
			return
